...
double E1(double x) {
  ...
  static double a56[N_56] = {8.5733287401, 18.0590169730, 8.6347608925,
                             0.2677737343};
  static double b56[N_56] = {9.5733223454, 25.6329561486, 21.0996530827,
                             3.9584969228};
  double E1 = 0.0;
  ...
  if (x <= 0.0) {
    ...
    E1 = -log(x) + a53[0] +
         x * (a53[1] + x * (a53[2] + x * (a53[3] + x * (a53[4] + x * a53[5]))));
