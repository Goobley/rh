...
void writeGeometry(Geometry *geometry) {
  ...
  if (!strcmp(input.geometry_output, "none"))
    return;

  if ((fp_out = fopen(input.geometry_output, "w")) == NULL) {
    sprintf(messageStr, "Unable to open output file %s", input.geometry_output);
  ...
  result = xdr_vector(&xdrs, (char *)xmu0, Nrays, sizeof(double),
                      (xdrproc_t)xdr_double);
  result = xdr_vector(&xdrs, (char *)wmu0, Nrays, sizeof(double),
                      (xdrproc_t)xdr_double);
  result = xdr_vector(&xdrs, (char *)geometry->r, Nradius, sizeof(double),
                      (xdrproc_t)xdr_double);
  result = xdr_vector(&xdrs, (char *)geometry->cmass, Nradius, sizeof(double),
                      (xdrproc_t)xdr_double);
  result = xdr_vector(&xdrs, (char *)geometry->tau_ref, Nradius, sizeof(double),
                      (xdrproc_t)xdr_double);
  result = xdr_vector(&xdrs, (char *)geometry->vel, Nradius, sizeof(double),
                      (xdrproc_t)xdr_double);
