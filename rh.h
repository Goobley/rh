...
enum Topology { ONE_D_PLANE, TWO_D_PLANE, SPHERICAL_SYMMETRIC, THREE_D_PLANE };
...
void Linear(int Ntable, double *xtable, double *ytable, int N, double *x,
            double *y, bool_t hunt);
