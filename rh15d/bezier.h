...
void cent_deriv_vec(double wprime[4], double dsup, double dsdn, double chiup[4],
                    double chic[4], double chidn[4]);

void cent_deriv_mat(double wprime[4][4], double dsup, double dsdn,
                    double chiup[4][4], double chic[4][4], double chidn[4][4]);

double cent_deriv(double dsup, double dsdn, double chiup, double chic,
                  double chidn);
void Svec(int k, double **S, double *Sf);

void Bezier3_coeffs(double dt, double *alpha, double *beta, double *gamma,
