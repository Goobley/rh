...
void Hydrostatic(int NmaxIter, double iterLimit) {
  ...
  double *n_k, **dfdn, C1, C2, C3, beta, Phi_H, Phi_H2, *F, *dFdne, *f, dnmax,
      nHtot_old, *np, *nH2;
  struct Ng *Nghse;
  Atom *atom;
  ...
  for (k = 0; k < atmos.Nspace; k++) {
    ...
    Nghse = NgInit(Nhse, Ngdelay = NG_HSE_DELAY, Ngorder = NG_HSE_ORDER,
                   Ngperiod = NG_HSE_PERIOD, n_k);
